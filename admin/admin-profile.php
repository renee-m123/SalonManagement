...
if (strlen($_SESSION['bpmsaid']==0)) {
  ...
  $mobno=$_POST['MobileNumber'];
     ...
     $query=mysqli_query($con, "update tbladmin set UserName ='$aname', MobileNumber='$mobno' where ID='$adminid'");
    if ($query) {
...
?>
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Contact Number</label> <input type="text" id="MobileNumber" name="MobileNumber" class="form-control" value="<?php  echo $row['MobileNumber'];?>"> </div>
