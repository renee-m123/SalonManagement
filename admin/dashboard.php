                ...
                <div class="row calender widget-shadow">
                    <div class="row-one">
                        <div class="col-md-4 widget">
                            <?php $query1=mysqli_query($con,"Select * from signuptbl");
...
?>
                        ...
                        <div class="col-md-4 widget states-mdl">
                            <?php $query2=mysqli_query($con,"Select * from tblappointments");
...
?>
                        ...
                        <div class="col-md-4 widget states-last">
                            <?php $query3=mysqli_query($con,"Select * from tblappointments where Status='1'");
...
?>
                ...
                <div class="row calender widget-shadow">
                    <div class="row-one">
                        <div class="col-md-4 widget">
                            <?php $query4=mysqli_query($con,"Select * from tblappointments where Status='1'");
...
?>
                ...
                <div class="row calender widget-shadow">
                    <div class="row-one">
                         ...
                         <div class="col-md-4 widget states-last">
                            <?php $query9=mysqli_query($con,"Select * from reviews");
